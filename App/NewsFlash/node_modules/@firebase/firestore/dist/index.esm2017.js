...
class Query {
    ...
    hasArrayContainsFilter() {
        return (this.filters.find(filter => filter instanceof RelationFilter &&
            filter.op === RelationOp.ARRAY_CONTAINS) !== undefined);
    }
    isDocumentQuery() {
                ...
                try {
                    switch (xhr.getLastErrorCode()) {
                        ...
                        case ErrorCode.HTTP_ERROR:
                            ...
                            debug(LOG_TAG, 'RPC "' + rpcName + '" failed with status:', status, 'response text:', xhr.getResponseText());
                            if (status > 0) {
...
class SimpleDbTransaction {
    constructor(transaction) {
        ...
        this.transaction.onerror = (event) => {
            this.completionDeferred.reject(event.target.error);
        };
    }
...
class SimpleDbStore {
    ...
    get(key) {
        ...
        return wrapRequest(request).next(result => {
            ...
            debug(LOG_TAG$1, 'GET', this.store.name, key, result);
            return result;
        });
    }
    delete(key) {
 ...
 * limitations under the License.
 */
const LOG_TAG$4 = 'MemoryPersistence';
/**
