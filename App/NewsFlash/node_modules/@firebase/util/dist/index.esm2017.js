...
const map = function (obj, f, opt_obj) {
    var res = {};
    for (var key in obj) {
...
const findKey = function (obj, fn, opt_this) {
    for (var key in obj) {
...
const findValue = function (obj, fn, opt_this) {
